...
namespace GGGMod.SuperiorCooler {
    ...
    public static class PatchManager {
        public static void Localization_Initialize_Patch() {
            Type root = typeof(GGGMod.SuperiorCooler.STRINGS);
            ...
            LocString.CreateLocStringKeys(typeof(GGGMod.SuperiorCooler.STRINGS.BUILDINGS));
        }
        public static void Db_Initialize_Postfix() {
            AddBuildingToTech("LiquidTemperature", SuperiorLiquidCoolerConfig.ID);
            AddPlanScreen("Utilities", "GGGMod", SuperiorLiquidCoolerConfig.ID);
            AddBuildingToTech("HVAC", SuperiorGasCoolerConfig.ID);
            AddPlanScreen("Utilities", "GGGMod", SuperiorGasCoolerConfig.ID);
        }
