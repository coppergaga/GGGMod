...
namespace GGGMod.Tools {
    public class GLocalization : GHarmonyPatchBase<GLocalization> {
        ...
        protected override void AfterInit() {
            Harmony.Patch(
                typeof(Localization),
                "Initialize",
                postfix: new HarmonyMethod(typeof(GLocalization), nameof(Localization_Initialize_Patch))
            );
        }
        ...
        /// </summary>
        public static void RegisterLoad(Type type) {
            Instance?.loadTypes.Add(type);
        }

        public static void RegisterAddStrings(Type type) {
            Instance?.addStringsTypes.Add(type);
        }
