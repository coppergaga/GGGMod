...
namespace GGGMod.GGSpacefarerModule {
    public class SpacefarerModuleProMaxConfig : IBuildingConfig {
        public const string ID = "GgHabitatModuleProMax";
        ...
        public override BuildingDef CreateBuildingDef() {
            BuildingDef obj = BuildingTemplates.CreateBuildingDef(ID, 5, 4, "rocket_habitat_medium_module_kanim", 1000, 60f, BUILDINGS.ROCKETRY_MASS_KG.DENSE_TIER1, MATERIALS.RAW_METALS, 9999f, BuildLocationRule.Anywhere, noise: NOISE_POLLUTION.NOISY.TIER2, decor: BUILDINGS.DECOR.NONE);
        ...
        public override void ConfigureBuildingTemplate(GameObject go, Tag prefab_tag) {
            ...
            go.AddOrGet<ClustercraftExteriorDoor>().interiorTemplateName = "expansion1::interiors/ggg_habitat_promax";
